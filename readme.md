# Course Code for [Using Hooks in React](http://www.pluralsight.com/courses/react-18-using-hooks) on Pluralsight

![Update Course Release!](ImportantNotice.png)

This source code is for the updated "Using Hooks in React" course released July 2025. It includes a completely new Module 10 titled *#Handle Forms Better with useActionState and useFormStatus**. In addition, there are many other sections of the course than have been updated to be current with React 19.
...
| **Course**                                                                           | Release Date  |
|-------------------------------------------------------------------------------------------------------------------------------|---------------|
| **[Using Hooks in React](https://pluralsight.com/courses/react-18-using-hooks/)**   *(this course)*                        | July 2025 |
...
| **[Working with Components in React](http://www.pluralsight.com/courses/react-18-working-components)**                               | February 2023 |
| **[What's New in React](https://pluralsight.com/courses/react-18-whats-new/)**                                             | May 2022      |
